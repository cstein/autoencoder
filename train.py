...
if __name__ == '__main__':
    ...
    ap.add_argument("--batch-size", metavar="SIZE", default=10, type=int, help="Size of the batch when training. Default is %(default)s.")
    ...
    for epoch in range(epochs):
        ...
        for step in range(len(train_input)//batch_size):
            ...
            # with tf.GradientTape() as tape:
            #    reconstructed, y_log = v(train_repr, training=True)
            #
